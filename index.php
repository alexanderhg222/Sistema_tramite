...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="plantilla/index2.html"><b>Login Tramite Documentario</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <div class="input-group mb-3">
                    <input type="email" class="form-control" placeholder="Usuario" id="txt_usuario">
    ...
    var usuarioInput = document.getElementById("txt_usuario");
    var passInput = document.getElementById("txt_contra");

    if (localStorage.checkbox && localStorage.checkbox != "") {
        rmcheck.setAttribute("checked", "checked");
        usuarioInput.value = localStorage.usuario;
        passInput.value = localStorage.pass;
        console.log("index" + passInput.value + " " + localStorage.usuario + " " + localStorage.pass);
    } else {
